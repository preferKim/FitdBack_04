    ...
    private fun showCountDown(text: Int) {
        ...
        if (text <= 0) {
            ...
            activity?.runOnUiThread {
                ...
                if (FeedbackAlgorithm.exr_mode == "free_exr") {
                    fr_sq_c!!.text =
                        " " + (FeedbackAlgorithm.squat_s + FeedbackAlgorithm.squat_f).toString() + "회"
                    fr_pl_c!!.text =
                        " " + (FeedbackAlgorithm.plank_s + FeedbackAlgorithm.plank_f).toString() + "초"
                    fr_slr_c!!.text =
                        " " + (FeedbackAlgorithm.sidelr_s + FeedbackAlgorithm.sidelr_f).toString() + "회"
